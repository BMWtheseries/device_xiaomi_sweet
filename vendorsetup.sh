...
git clone https://github.com/BMWtheseries/android_hardware_qcom_audio -b 13-sm8150 hardware/qcom-caf/sm8150/audio
git clone https://github.com/BMWtheseries/android_hardware_qcom_display -b 13-sm8150 hardware/qcom-caf/sm8150/display
git clone https://github.com/BMWtheseries/android_hardware_qcom_media -b 13-sm8150 hardware/qcom-caf/sm8150/media
