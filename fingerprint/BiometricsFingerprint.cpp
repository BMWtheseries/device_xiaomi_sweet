...
#define LOG_TAG "android.hardware.biometrics.fingerprint@2.3-service.sweet"
...
BiometricsFingerprint::BiometricsFingerprint()
    : mClientCallback(nullptr),
      mDevice(nullptr),
      mBoostHintIsSupported(false),
      mBoostHintSupportIsChecked(false),
